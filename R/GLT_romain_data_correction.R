...
data.clean.final$IdadeOK[which(data.clean.final$GLT=="1302" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="1313" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="1313" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AF12" & data.clean.final$Year > 2009)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AF13" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AF25" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AX22" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AX23" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="AX24" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="BE10" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="BE9" & data.clean.final$Year > 2008)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA1" & data.clean.final$Year > 2007)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA2" & data.clean.final$Year > 2007)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA10" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA11" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA12" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA20" & data.clean.final$Year > 2015)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA21" & data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA22" & data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA32" & data.clean.final$Year > 2018)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA33" & data.clean.final$Year > 2018)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="FA35" & data.clean.final$Year > 2018)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="JP16" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="JP17" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="JP20" &  data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="JP23")]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP102" &  data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP103" &  data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP119" &  data.clean.final$Year > 2014)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP152" &  data.clean.final$Year > 2015)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP153" &  data.clean.final$Year > 2015)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP155" &  data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP156" &  data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP176" &  data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP177" &  data.clean.final$Year > 2016)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP178" &  data.clean.final$Year > 2017)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP179" &  data.clean.final$Year > 2017)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP20" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP207" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP208" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP209" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP21" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP212" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP214" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP215" &  data.clean.final$Year > 2019)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP232" &  data.clean.final$Year > 2020)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP233" &  data.clean.final$Year > 2020)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP26" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP30" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP31" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP36" &  data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP40" &  data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP50" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP51" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP52" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP53" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP58" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP61" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP72" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP76" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP77" & data.clean.final$Year > 2011)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP78" & data.clean.final$Year > 2011)]<-"AD"

data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP79")]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP83")]<-"AD"

data.clean.final$IdadeOK[which(data.clean.final$GLT=="MP86" & data.clean.final$Year > 2013)]<-"AD"

data.clean.final$IdadeOK[which(data.clean.final$GLT=="SP16" & data.clean.final$Year > 2007)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="SP14" & data.clean.final$Year > 2007)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="SP15" & data.clean.final$Year > 2007)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="SP21" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="SP23" & data.clean.final$Year > 2013)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="TM8" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="TM9" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="UR7" & data.clean.final$Year > 2020)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="XT1" & data.clean.final$Year > 2010)]<-"AD"
data.clean.final$IdadeOK[which(data.clean.final$GLT=="XT2" & data.clean.final$Year > 2010)]<-"AD"
