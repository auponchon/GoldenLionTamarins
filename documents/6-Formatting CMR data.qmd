  ...
  dplyr::filter( Year < 2010 &  
                 Group!="CB" & 
                  ...
                  GLT %in% unique(data.clean.final$GLT
                                  [data.clean.final$UMMPs=="Rio Vermelho" |
...
format<-distinct.sum.up %>% 
 ...
 write.table(format, file=here::here("CMR", "data", 
                                     "CMR_1state_AD_AldeiaI-II_RV_1989-2009.inp"),
                 quote=F,row.names=F ,
                 sep=" ",
                 col.names=F)
...
format<-distinct.sum.up %>% 
 ...
 write.table(format, file=here::here("CMR", "data", "CMR_1state_AD_NOsex_filt78GP_allperiods.inp"),
                 quote=F,row.names=F ,
                 sep=" ",
                 col.names=F)
```
